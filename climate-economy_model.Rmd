...
BAU.Loss.Table <- BAU.Loss.df %>% 
  mutate(t = row.names(.),
         ...
         Precent.Loss.4 = percent(Precent.Loss.4),
         Precent.Loss.4 = color_tile("#DeF7E9", "#71CA97") (Precent.Loss.4)) %>%
  rename("Year" = t,
...
export_formattable(BAU.Loss.Table, here::here("figures", "BAU.Loss,Table.png"))
